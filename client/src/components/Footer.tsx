...
export function Footer() {
  const socialLinks = [
    {
      icon: Facebook,
      href: "https://www.facebook.com/share/17WrpEbFyS/",
      label: "Facebook",
      bg: "#1877F2",
    },
    {
      icon: Instagram,
      href: "https://www.instagram.com/vivekjha3017?utm_source=qr&igsh=MWd0dzV6eDAxYWhpOQ==",
      label: "Instagram",
      bg: "radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%,#d6249f 60%,#285AEB 90%)",
    },
    {
      icon: Youtube,
      href: "https://youtube.com/@cga10th?si=kPSsHOeKhelD0jhm",
      label: "YouTube",
      bg: "#FF0000",
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              ...
              education, expert guidance, and a commitment to excellence since
              2010.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li>
                <Link
                  href="/courses"
                  className="hover:text-primary transition-colors text-left inline-block"
                >
                  Junior Programs
                  <br />
                  Class ( 1st to 8th )
              ...
              <li>
                <Link
                  ...
                  className="hover:text-primary transition-colors"
                >
                  Foundation Classes (9th to 10th)
                </Link>
              </li>
              <li>
                <Link
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  href="https://mail.google.com/mail/?view=cm&to=careergoalacademy00@gmail.com"
                  target="_blank"
                  rel="noopener noreferrer"
