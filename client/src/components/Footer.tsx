      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><Link href="/courses" className="hover:text-primary transition-colors">NEET Crash Course</Link></li>
              <li><Link href="/courses" className="hover:text-primary transition-colors">IIT JEE Mains + Advanced</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-400">123 Education Hub, South Extension Part 1, New Delhi, 110049</span>
              </li>
