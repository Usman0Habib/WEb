      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500">Find a learning center near you in Delhi</p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            {/* Map Placeholder */}
            <div className="lg:col-span-2 bg-slate-200 rounded-2xl overflow-hidden shadow-inner border border-slate-300 h-[500px] relative group">
              {/* Using a static map image from Unsplash */}
              {/* map of delhi city streets view */}
              <img 
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/10 group-hover:bg-transparent transition-colors">
                <Button variant="secondary" className="shadow-lg pointer-events-none">
                  <MapPin className="mr-2 h-4 w-4" /> Interactive Map View
                </Button>
              </div>
            </div>
            ...
            <div className="space-y-4 h-[500px] overflow-y-auto pr-2 custom-scrollbar">
              {locations?.map((loc) => (
                <div key={loc.id} className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:border-primary/30 transition-colors cursor-pointer group">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <Badge variant="outline" className="text-xs">Lat: {loc.latitude}</Badge>
                        <Badge variant="outline" className="text-xs">Long: {loc.longitude}</Badge>
                      </div>
                    </div>
                  </div>
                </div>
